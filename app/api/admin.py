...
PROMPT_VARIABLES = {
    ...
    "content": {
        ...
        "variables": [
            ...
            {"key": "selected_stills", "description": "Generic formatted stills"},
            {"key": "problem_stills", "description": "Problem-type stills only"},
            {"key": "insight_stills", "description": "Insight-type stills only"},
            {"key": "solution_stills", "description": "Solution-type stills only"},
            {"key": "data_stills", "description": "Data/stat stills only"},
            {"key": "story_stills", "description": "Story/example stills only"},
            {"key": "quote_stills", "description": "Quotes with attribution"},
